...
/** The contents of this file are taken from `scalaz` (https://github.com/scalaz/scalaz).
  * They don't have a license in their github repo, but maven-central lists scalaz under BSD2. */
