...
/*
 * This is a modified version of a file taken from the Apache Commons Lucene project.
 */
...
public class OpenBitSet {
  ...
  */
    ...
    /* the following methods are taken from ArrayUtil.java (from apache lucene) */
    ...
    public static int oversize(int minTargetSize, int bytesPerElement) {
...

        {
            ...
            //I've deleted the code for 32bit, since I didn't copy the code to detect 64bit JRE
