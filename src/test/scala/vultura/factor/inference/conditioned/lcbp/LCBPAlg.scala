...
object LCBP_G_Exact extends LCBPAlg[LCBPGeneral] {
  override def inferWithScheme(s: FactoredScheme, tol: Double = 1e-12, maxIter: Int = 10000): (MargParI, Boolean, LCBPGeneral) = {
...
object LCBP_BP extends LCBPAlg[LcbpMetaBP] {
  override def inferWithScheme(s: FactoredScheme, tol: Double = 1e-12, maxIter: Int = 10000): (MargParI, Boolean, LcbpMetaBP) = {
